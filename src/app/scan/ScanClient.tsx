...
export default function ScanPage() {
  ...
  return (
    <main className="min-h-screen bg-[#020202] pt-24 md:pt-32 pb-20 px-6">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6 md:gap-8">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-3">
              <Terminal size={16} className="text-[#39FF14] shrink-0" />
              <h1 className="text-large md:text-6xl font-bebas text-white uppercase tracking-[1px] break-all leading-tight">
                {terminalTitle || "NEURAL_SCAN_TERMINAL_V4"}
              </h1>
            </div>
            <p className="font-mono text-[9px] md:text-[10px] text-[#444] uppercase tracking-[3px]">
