      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8">
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-large md:text-7xl font-mono font-bold text-white leading-tight uppercase tracking-tighter break-words">
              MEDICINE <br />
              MARKETPLACE<span className="animate-pulse">_</span>
            </h1>
          </div>
          <p className="text-[#555555] max-w-sm font-mono text-[10px] md:text-xs leading-relaxed uppercase tracking-tighter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
          <div className="relative">
            <Input 
              ...
              className="pr-10"
              aria-label="Search medicine marketplace"
            />
            <Search className="absolute right-4 top-1/2 -translate-y-1/2 text-[#444]" size={14} aria-hidden="true" />
          </div>
          <div className="relative">
            <select
            ...
            <MapPin className="absolute right-4 top-1/2 -translate-y-1/2 text-[#39FF14]" size={16} aria-hidden="true" />
          </div>
